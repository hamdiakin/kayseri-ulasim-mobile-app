...
class LineTimingsAlternative extends StatefulWidget {
  final String busName;
  final String busCode;
  final String firstStation;
  final String lastStation;

  const LineTimingsAlternative(
      this.busName, this.busCode, this.firstStation, this.lastStation);

  @override
  _LineTimingsAlternativeState createState() => _LineTimingsAlternativeState(
...
class _LineTimingsAlternativeState extends State<LineTimingsAlternative> {
  _LineTimingsAlternativeState(
      {this.busName, this.busCode, this.firstStation, this.lastStation});
